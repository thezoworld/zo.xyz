      ...
      <Flex col items="center" className="mx-4 w-full mt-12">
        ...
        <Flex items="center" className="mt-4 mb-8">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mx-4 flex items-center justify-center px-6 py-2 leading-none rounded-xl border-white border text-white"
          >
            <Discord className="w-6 h-6 mr-3" fill="white" />
            Discord
          </a>
          <a
            ...
            className="mx-4 flex items-center justify-center px-6 py-2 leading-none rounded-xl border-white border text-white"
          >
            <TwitterFilled className="w-6 h-6 mr-3" fill="white" />
            Twitter
          </a>
        </Flex>
      </Flex>
